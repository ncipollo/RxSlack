...
class RxDataStore extends MemoryDataStore {
    ...
    fetchUsers() {
        return Rx.Observable.from(this.allUsers())
    }
    ...
    fetchChannels() {
        return Rx.Observable.from(this.allChannels())
    }
    ...
    setGroup(group) {
        ...
        this.updateRxChannel(groupId,group);
    }

    //noinspection JSUnusedGlobalSymbols
    upsertGroup(group) {
        super.upsertGroup(group);
        let groupId = null;
        if(group != null) {
            groupId = group["id"];
        }
    ...
    removeGroup(groupId) {
        ...
        this.updateRxChannel(groupId, null, null);
